<nav role="navigation" id="navigation" class="nav megamenu">
    <h1 class="section" role="heading" aria-level="1">navigation du site</h1>
    <a class="reader" href="#main">Passer directement au contenu</a>

    <div class="hero menu wrapper">
        <a class="menuLink" tabindex="8" href="javascript:void()" title="Ouvrir le menu">
            <span class="icon icon-menu"></span>
            Menu</a>
    </div>
    <ol role="menubar" class="invisible-link wrapper">
        <li><a href="/etudeetvie2/" class="active" title="Aller à l'accueil du site" tabindex="9">Accueil</a></li>
        <li><a class="moreLink" href="javascript:void()" id="anti-onde" aria-haspopup="true" aria-controls="anti-onde-m" aria-expanded="false" aria-owns="anti-onde-m" tabindex="10"><span class="icon icon-chevron-right-white">Développer</span>Protection
                anti-onde</a>
        ...
        <li><a class="moreLink" href="javascript:void()" tabindex="19" id="mesure" aria-haspopup="true" aria-controls="mesure-m" aria-expanded="false" aria-owns="mesure-m"><span class="icon icon-chevron-right-white">Développer</span>Instruments de
                mesure</a>
        ...
        <li><a class="moreLink" tabindex="29" href="javascript:void()"  id="pollution" aria-haspopup="true" aria-controls="pollution-m" aria-expanded="false" aria-owns="pollution-m"> <span class="icon icon-chevron-right-white">Développer</span>Anti pollution
                électrique</a>
        ...
        <li><a class="moreLink" tabindex="37" href="javascript:void()" id="protect" aria-haspopup="true" aria-controls="protect-m" aria-expanded="false" aria-owns="protect-m"> <span class="icon icon-chevron-right-white">Développer</span>Protection haute
                fréquence</a>
